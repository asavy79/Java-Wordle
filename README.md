...
- `StandardLetterEvaluator` implements the standard Wordle evaluation logic (handles duplicate letters correctly)
...
### Builder Pattern
**Location** `Wordle/WordleGame.java`

To ensure games can be customizable, we implemented the builder pattern:
- Makes sure proper configurations are given 
- Uses default values if certain ones are not given
